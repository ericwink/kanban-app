...
export default function Boardview({ board, sidebar, boardIndex, setBoardData }: Props) {
  ...
  return (
    <div id="board-view" data-sidebar={sidebar ? "show" : "hidden"}>
      {board.columns?.map((col, index) => {
        return <Column boardIndex={boardIndex} columnIndex={index} column={col} key={col.name} colNames={colNames} setBoardData={setBoardData} />;
      })}
